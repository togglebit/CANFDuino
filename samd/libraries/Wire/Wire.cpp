...
void TwoWire::begin(void) {
  ...
  flag = pinPeripheral(_uc_pinSDA, PIO_SERCOM);
  Serial.print("flag sda"); Serial.println(flag,DEC);
  flag = pinPeripheral(_uc_pinSCL, PIO_SERCOM);
  Serial.print("flag scl"); Serial.println(flag,DEC);
}
